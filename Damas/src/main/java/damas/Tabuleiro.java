...
/* 181 */       if (fl == 1) {
/*     */         
/* 183 */         lista_jogadas.instavel.addElement(Boolean.TRUE);
/*     */       }
/*     */       else {
/*     */         
/* 187 */         lista_jogadas.instavel.addElement(Boolean.FALSE);
/*     */       } 
...
/*     */ 
/*     */           
/* 227 */           lista_jogadas.instavel.addElement(Boolean.FALSE); }
/*     */       } 
...
/* 375 */           /*     */           /*     */           /* 378 */           /*     */
                if ((proibido != 2 || dirx * diry <= 0) &&
                         x + 2 * dirx >= 0
                        && x + 2 * dirx <= 7 && y + 2 * diry >= 0
                        && y + 2 * diry <= 7
                        && t1.matriz[x + dirx][y + diry] * t1.matriz[x][y] <= 0) {
                    /*     */
                    /* 382 */
                        /*     */
                        /*     */
                        ...
                        /*     */
                        /* 404 */
                        for (; x + ncasas * dirx >= 0 && x + ncasas * dirx <= 7 &&
                            ...
                            /* 431 */
                                ...
                                /*     */
                                /* 447 */
                                int i = movimentos.size() - 1;
                                /* 448 */
                                movimentos.removeElementAt(i);
                                /* 449 */
                                moveu = true;
                            }
                            /*     */
...
/*     */ 
/*     */     
/* 480 */     lista_jogadas.instavel.addElement(Boolean.TRUE);
...
/* 661 */         t1.copia(t2);
/*     */         
/* 663 */         AplicaTabuleiro.aplica((Vector<?>) candidatos.movimentos.elementAt(i), t2);
/*     */         
...
/* 683 */     t1.copia(t2);
/*     */     
/* 685 */     AplicaTabuleiro.aplica((Vector<?>) candidatos.movimentos.elementAt(melhor_indice), t2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 727 */       t1.copia(t2);
/*     */       
/* 729 */       AplicaTabuleiro.aplica((Vector<?>) candidatos.movimentos.elementAt(i), t2);
/*     */       
...
/* 783 */       t1.copia(t2);
/*     */       
/* 785 */       AplicaTabuleiro.aplica((Vector<?>) candidatos.movimentos.elementAt(i), t2);
/*     */       
